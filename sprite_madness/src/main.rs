...
const SCENE_HEIGHT: f32 = 900.0;
pub const RESOLUTION: f32 = 16.0 / 9.0;
pub const TILE_SIZE: f32 = 0.10;
pub const CLEAR: Color = Color::rgb(0.04, 0.04, 0.04);

// add a texture handle to keep the reference of the texture avaiable to all game
